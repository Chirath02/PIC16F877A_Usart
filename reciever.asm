...
BANKSEL PIR1
CHECK:
	BTFSS PIR1, RCIF ; check for completion if reception
	GOTO CHECK

BANKSEL RCSTA 
MOVF RCSTA, 0 ;Ger the recived byte
BANKSEL 0X20
MOVWF 0X20 ; ky value stored to 0x20
CALL DISPLAY ; call display and display the key pressed
GOTO TERMINATE
